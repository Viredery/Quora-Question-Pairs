...
if True:
    ...
    train_feat_csv = [train_fuzz_feat,
                      train_determiner,
                      train_hamming, 
                      train_leak_feat, 
                      train_len,
    ...
    leaks = pd.concat(train_feat_csv, axis=1).astype(float).fillna(0.0)
    test_leaks = pd.concat(test_feat_csv, axis=1).astype(float).fillna(0.0)
